...
func Initialize_Variables_Demo() {
	...
	/// NEW VARIABLES
	/////////////////////////
	// if you dont use any initialized variable, go compiler will give error.
	var b1 bool = true // typed declaration with initial value
	b2 := true         // untyped declaration with initial value. but type is automatic assing on runtime.
